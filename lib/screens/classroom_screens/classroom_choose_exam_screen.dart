...
class ClassroomChooseExamScreen extends StatelessWidget {
  const ClassroomChooseExamScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(
        () => levelController.isLoading.value || gradeController.isLoading.value
            ? const Center(
                                              ...
                                              child: classroomController
                                                  ...
                                                  ? Row(
                                                      children: [
                                                        Expanded(
                                                          child: Text(
                                                              '${classroomController.chosenAssignChapter.value!.name}: ${classroomController.chosenAssignQuizMatrix.value!.name!}'),
                                                        )
                                                      ],
                                                    )
                                                  : const Text(
