...
class ClassroomHomeworkResultScreen extends StatelessWidget {
  const ClassroomHomeworkResultScreen({super.key});
                          ...
                          child: SizedBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                ClassroomHomeworkResultsListView(
                                    title:
                                        'Tổng số bài đã làm: ${classroomController.resultList.length}',
                                    numOfItems:
                                        classroomController.resultList.length,
...
class ClassroomHomeworkResultsListView extends StatelessWidget {
  ClassroomHomeworkResultsListView(
      {super.key,
      required this.title,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        classroomController.resultList[index]
                                                    .student.imageUrl ==
                                                null
                                            ? Container(
                                                height: 45,
                                                    ...
                                                    child: RichText(
                                                      text: TextSpan(
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                            text:
                                                                '${classroomController.resultList[index].student.fullname}',
                                                            style: const TextStyle(
                                                                fontWeight:
                                                                    FontWeight
                                                                        .bold), // In đậm
                                                  ...
                                                  ? Row(
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            Text(
                                                              'Số câu đúng: ${classroomController.resultList[index].result!.correctAnswers}/${classroomController.resultList[index].result!.totalQuiz}',
                                                              style: const TextStyle(
                                                                  color: Colors
                                                                      .black54,
                                                                  fontSize: 13),
                                                  ...
                                                  ? Row(
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            Text(
                                                              'Số lần làm: ${classroomController.resultList[index].result!.correctAnswers}/${classroomController.resultList[index].result!.totalQuiz}',
                                                              style: const TextStyle(
                                                                  color: Colors
                                                                      .black54,
                                                                  fontSize: 13),
                                        ...
                                        if (classroomController
                                          ...
                                          Column(
                                            children: [
                                              Text(
                                                '${scoreFormatter(classroomController.resultList[index].result!.score!)}',
                                                style: TextStyle(
                                                    color: ColorPalette
                                                        .primaryColor,
                                                    fontWeight: FontWeight.w600,
